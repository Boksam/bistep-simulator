"""Salinity simulation model.

This module contains the SalinitySimulator class, which is responsible
for analyzing historical salinity data and generating future synthetic
...
class SalinitySimulator:
    """Simulates future salinity data based on historical patterns.

    This class decomposes a time series of salinity into trend,
    ...
    def _handle_outliers(
        ...
        Args:
            ...
            absolute_threshold: The absolute salinity threshold.
    ...
    def load_and_prepare_data(self, csv_path: str) -> pd.Series:
        """Loads, preprocesses, and interpolates salinity data.

        Assumes the CSV has "timestamp" and "salinity" columns.
        ...
        try:
            ...
            series = df["salinity"].copy()
            series.name = "hourly_avg_salinity"
    ...
    def run_analysis(
        ...
        Returns:
            The fitted SalinitySimulator instance.
        """
